...
from bayesinsight.models.variablemodels import ExogVariableDetails, ControlVariableDetails, MediaVariableDetails, LocalTrendsVariableDetails, SeasonVariableDetails

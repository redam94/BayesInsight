from bayesinsight.types.distribution_types import PosDist, Distribution, ContDist
from bayesinsight.lib.utils import row_ids_to_ind_map, var_dims, enforce_dim_order, check_coord, check_dim
